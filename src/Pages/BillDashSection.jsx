...
const BillDashSection = () => {
  return (
    ...
    <div className="pl-7 text-base font-semibold text-gray-400">
      ...
      <div className="shadow-md border-2 w- border-orange-500 m-7  rounded-md flex items-center justify-center p-5">
        <Button
          title="You're on the free plan. Your trial ended on 7 February 2025."
...
export default BillDashSection;

    ...
    <>
      <div className="grid grid-cols-4 gap-4 m-8">
        {plans.map((plan, index) => (
          <div
            key={index}
            className="w-full bg-white rounded-2xl shadow-sm p-7 relative flex flex-col"
          >
            ...
            {index === 2 && (
              <div className="p-3 gap-2 text-sm mt-8 bg-blue-50 rounded-lg last:mt-auto">
                <Button
                  title="Optional add-on"
                  type="secondary"
                  extraStyles="bg-blue-100 rounded-full flex   text-black font-light text-xs border-none h-6"
                />
                <div>
                  <Button
                    title="Single Sign-on."
                    beforeIcon={<GoPlus className="w-6 h-6 font-extrabold text-blue-600" />}
                    type="secondary"
                    extraStyles=" rounded-full flex   text-blue-900 font-light text-sm border-none"
                  />
                </div>
                <div>
